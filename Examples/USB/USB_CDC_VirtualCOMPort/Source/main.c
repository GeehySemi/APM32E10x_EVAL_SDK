...
/** @defgroup USB_CDC_Macros Macros
  @{
*/
...
/**@} end of group USB_CDC_Macros*/

/** @defgroup USB_CDC_Variables Variables
  @{
  */
...
/**@} end of group USB_CDC_Variables*/

/** @defgroup USB_CDC_Functions Functions
  @{
  */
...
{
    APM_EVAL_Init();
    printf("This is an example of USB CDC \r\n");
...
void Menu_DisplayInit(void)
{
    ...
    LCD_DisplayString(20, LCD_LINE_1, "ID Product = 0x0108", LCD_TEXT_FC, LCD_TEXT_BC, 16, 0);
...
/**@} end of group USB_CDC_Functions */
