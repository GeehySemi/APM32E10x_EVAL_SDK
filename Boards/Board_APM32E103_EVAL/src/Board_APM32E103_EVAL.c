...
/* Includes */
#include "Board_APM32E103_EVAL.h"
...
const uint16_t BUTTON_EINT_LINE[BUTTONn] =
{
...
const GPIO_PORT_SOURCE_T BUTTON_PORT_SOURCE[BUTTONn] =
{
...
const GPIO_PIN_SOURCE_T BUTTON_PIN_SOURCE[BUTTONn] =
{
