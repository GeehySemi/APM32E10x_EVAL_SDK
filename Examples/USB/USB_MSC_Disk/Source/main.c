...
/** @defgroup USB_MSC_Macros Macros
  @{
*/
...
/**@} end of group USB_MSC_Macros*/

/** @defgroup USB_MSC_Variables Variables
  @{
  */
...
/**@} end of group USB_MSC_Variables*/

/** @defgroup USB_MSC_Functions Functions
  @{
  */
...
{
    APM_EVAL_Init();
    printf("This is an example of USB MSC\r\n");
...
void Menu_DisplayInit(void)
{
    ...
    LCD_DisplayString(20, LCD_LINE_1, "ID Product = 0x0109", LCD_TEXT_FC, LCD_TEXT_BC, 16, 0);
...
/**@} end of group USB_MSC_Functions */
/**@} end of group USB_MSC */
